...
/**
 * Based on https://github.com/osdnk/react-native-reanimated-bottom-sheet/blob/master/src/index.tsx
 * But made to snap from right to left instead of bottom to top
 */
...
export default class BottomSheetBehavior extends React.Component<Props, State> {
  ...
  private handleMasterPan = event([
    {
      nativeEvent: {
        translationX: this.dragMasterY,
        state: this.panMasterState,
        velocityX: this.masterVelocity,
      },
    },
  ])
  ...
  private handlePan = event([
    {
      nativeEvent: {
        translationX: this.props.enabledInnerScrolling
          ? this.dragY
          : this.dragMasterY,
        state: this.props.enabledInnerScrolling
          ? this.panState
          : this.panMasterState,
        velocityX: this.props.enabledInnerScrolling
          ? this.velocity
          : this.masterVelocity
      }
    }
  ...
  private handleFullHeader = ({
    ...
    requestAnimationFrame(() => this.height.setValue(width))
  ...
  private handleLayoutContent = ({
    ...
    this.state.heightOfContent.setValue(width - this.state.initSnap)
      ...
      <>
        ...
        <Animated.View
          style={{
            ...
            transform: [
              {
                translateX: this.translateMaster
              },
              {
                translateX: sub(this.height, this.state.initSnap) as any
              }
            ]
          }}
        >
          ...
          <View
            style={
              this.props.enabledInnerScrolling && {
                width: this.state.initSnap - this.state.heightOfHeader,
              ...
              <Animated.View>
                ...
                >
                  <Animated.View
                    style={{
                      height: '100%',
                      transform: [{ translateX: this.Y as any }],
                    }}
